...
public class ServletTest {
    ...
    public void doPostAuth() throws Exception {
        when(request.getParameter("login")).thenReturn("mlogin");
        ...
        assertTrue(stringWriter.toString().contains("Misha"));
        assertTrue(stringWriter.toString().contains("Misha"));
    ...
    public void doPostAuthSuperUser() throws Exception {
        when(request.getParameter("login")).thenReturn("dlogin");
        when(request.getParameter("pass")).thenReturn("1234");
        HttpSession session = mock(HttpSession.class);
        when(request.getSession()).thenReturn(session);
        when(request.getParameter("sign")).thenReturn("in");
    ...
    public void doGetUnblock() throws Exception {
        when(request.getParameter("card")).thenReturn("100101");
